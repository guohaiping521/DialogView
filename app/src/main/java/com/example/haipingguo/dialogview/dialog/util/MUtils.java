...
public class MUtils {
    ...
    public static void showKeyboard(
        @NonNull final DialogInterface di, @NonNull final MDialog.Builder builder) {
        final MDialog dialog = (MDialog) di;
    ...
    public static ColorStateList getActionTextStateList(Context context, int newPrimaryColor) {
        final int fallBackButtonColor =
            MUtils.resolveColor(context, android.R.attr.textColorPrimary);
        ...
        int[] colors = new int[]{MUtils.adjustAlpha(newPrimaryColor, 0.4f), newPrimaryColor};
